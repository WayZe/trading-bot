...
| 💤 Heartbeat | дайджест «позиция/equity/возраст свечи/свитчи», раз в `heartbeat_hours` (0 — выключить); **только в режиме постоянного процесса** — таймер живёт в памяти процесса, при cron-эксплуатации (`--once`) дайджеста нет | — |
